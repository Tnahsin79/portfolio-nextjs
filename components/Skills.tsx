        ...
        <div className="relative">
          ...
          <div className="flex animate-scroll hover:[animation-play-state:paused]">
            {duplicatedSkills.map((skill, index) => (
              ...
              >
                <span className="text-gray-400 text-sm md:text-base font-medium whitespace-nowrap hover:text-accent transition-colors duration-300 cursor-default hover:scale-110 inline-block transform">
                  {skill}
                </span>
              </div>
            ))}
